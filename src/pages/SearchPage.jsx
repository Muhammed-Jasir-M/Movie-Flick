            ...
            <div className="flex flex-col justify-center items-center w-full mt-6">
                {loading && page === 1 ? (
                    ...
                    activeTab === 'person' ? (
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-x-3 md:gap-x-4 gap-y-4 pt-4 pb-4 w-full px-1.5 md:px-4">
